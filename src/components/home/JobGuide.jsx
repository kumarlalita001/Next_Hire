...
export default function JobGuide({ scrollToCompareColleges, scrollToCounseling }) {
  ...
  const steps = [
    {
      ...
      description:
        "Create a professional resume using our smart resume builder and stand out to employers.",
    ...
    },
    {
      ...
      title: "Job Discovery",
      description:
        "Search and filter jobs based on your skills, experience, and preferred location.",
    ...
    },
    {
      ...
      title: "Application Process",
      description:
        "Apply directly to job listings, track your applications, and get instant updates.",
    ...
    },
    {
      ...
      description:
        "Prepare for interviews with mock sessions and get help with offer negotiation and onboarding.",
      buttonText: "Get Career Help",
      action: scrollToCounseling,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-no-repeat bg-cover bg-black text-white p-6 md:p-12">
      <motion.div
        initial="hidden"
        animate="visible"
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-12">
          <h1 className="text-2xl md:text-3xl font-bold mb-2">Hiring Guide</h1>
          <p className="text-gray-400">
            Your step-by-step journey to landing your dream job
          </p>
        </motion.div>
      ...
      {/* Optional Modal for Resume Builder or Guide */}
      {/* You can replace this with any custom modal implementation */}
      {/* <Modal ... /> */}
    </div>
  );
}
